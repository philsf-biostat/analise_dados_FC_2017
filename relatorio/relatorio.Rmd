...
Parece haver uma associação estatísticamente significativa entre a quantidade de níveis na cirirgia e a prevalência de disfonia (p-valor = `r format.or(niveis.disfon)`).
...
quantidade de níveis na cirirgia (p-valor = `r format.or(niveis.disfag)`).
